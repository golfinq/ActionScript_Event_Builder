package flash.events
{
    ...
    public class DRMAuthenticationErrorEvent extends ErrorEvent
    {
        ...
        {
            return new DRMAuthenticationErrorEvent(this.type,this.bubbles,this.cancelable,this.eventPhase,this.text,this.errorID,this.subErrorID,this.serverURL,this.domain);
        }
    }
}