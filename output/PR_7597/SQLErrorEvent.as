package flash.events
{
    ...
    public class SQLErrorEvent extends ErrorEvent
    {
        ...
        {
            return new SQLErrorEvent(this.type,this.bubbles,this.cancelable,this.eventPhase,this.text,this.errorID,this.error);
        }

        // [override] Returns a string that contains all the properties of the SQLErrorEvent object.
        override public function toString():String
        {
            return this.formatToString("SQLErrorEvent","type","bubbles","cancelable","eventPhase","text",error);
        }
