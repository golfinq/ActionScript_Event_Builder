package flash.events
{
    ...
    public class DRMReturnVoucherErrorEvent extends ErrorEvent
    {
        ...
        {
            return new DRMReturnVoucherErrorEvent(this.type,this.bubbles,this.cancelable,this.eventPhase,this.text,this.errorID,this.subErrorID,this.serverURL,this.licenseID,this.policyID);
        }
    }
}