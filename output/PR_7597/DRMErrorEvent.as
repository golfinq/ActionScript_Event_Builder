package flash.events
{
    ...
    public class DRMErrorEvent extends ErrorEvent
    {
        ...
        private var _subErrorID: int; // [read-only] An error ID that indicates more detailed information about the underlying problem.
        private var _systemUpdateNeeded: Boolean; // [read-only] Indicates whether a system update is needed to play the DRM-protected content.
        private var _drmUpdateNeeded: Boolean; // [read-only] Indicates whether a DRM update is needed to play the DRM-protected content.
        ...
        {
            super(type,bubbles,cancelable,inErrorDetail,inErrorCode,inMetadata);
        ...
        {
            return new DRMErrorEvent(this.type,this.bubbles,this.cancelable,this.eventPhase,this.text,this.errorID,this.subErrorID,this.systemUpdateNeeded,this.drmUpdateNeeded);
        }

        // [override] Returns a string that contains all the properties of the DRMErrorEvent object.
        override public function toString():String
        {
            return this.formatToString("DRMErrorEvent","type","bubbles","cancelable","eventPhase","text","subErrorID","systemUpdateNeeded","drmUpdateNeeded","contentData");
        }
