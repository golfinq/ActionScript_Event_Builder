package flash.events
{
    ...
    public class AVDictionaryDataEvent extends Event
    {
        ...
        private var _dictionary: Dictionary; // [read-only] Contains a dictionary of keys and values for the ID3 tags.
        private var _time: Number; // [read-only] The timestamp for the ID3 tag.
