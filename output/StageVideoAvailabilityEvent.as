package flash.events
{
    ...
    public class StageVideoAvailabilityEvent extends Event
    {
        ...
        private var _availability: String; // [read-only] Reports the current availability of stage video using a constant of the flash.media.StageVideoAvailability class.
