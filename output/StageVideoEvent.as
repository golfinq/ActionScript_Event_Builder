package flash.events
{
    ...
    public class StageVideoEvent extends Event
    {
        ...
        private var _status: String; // [read-only] The status of the StageVideo object.
        private var _colorSpace: String; // [read-only] The color space used by the video being displayed in the StageVideo object.
