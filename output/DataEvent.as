package flash.events
{
    ...
    public class DataEvent extends TextEvent
    {
        ...
        {
            return new DataEvent(this.type,this.bubbles,this.cancelable,this.eventPhase,this.text,this.data);
        }

        // [override] Returns a string that contains all the properties of the DataEvent object.
        override public function toString():String
        {
            return this.formatToString("DataEvent","type","bubbles","cancelable","eventPhase","activating",data);
        }
    }
}