package flash.events
{
    ...
    public class NetDataEvent extends Event
    {
        ...
        private var _timestamp: Number; // [read-only] The timestamp of the data message in the media stream.
        private var _info: Object; // [read-only] A data object describing the message.
