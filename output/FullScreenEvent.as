package flash.events
{
    ...
    public class FullScreenEvent extends ActivityEvent
    {
        ...
        private var _fullScreen: Boolean; // [read-only] Indicates whether the Stage object is in full-screen mode (true) or not (false).
        private var _interactive: Boolean; // [read-only] Indicates whether the Stage object is in full-screen interactive mode (true) or not (false).
        ...
        {
            return new FullScreenEvent(this.type,this.bubbles,this.cancelable,this.eventPhase,this.activating,this.fullScreen,this.interactive);
        }
