package flash.events
{
    ...
    public class SoftKeyboardEvent extends Event
    {
        ...
        private var _triggerType: String; // [read-only] Indicates whether the change in keyboard status has been triggered by an application (such as programmatic use of requestSoftKeyboard()) or by the user (such as selecting a text field).
        ...
        {
            return this.formatToString("SoftKeyboardEvent","type","bubbles","cancelable","eventPhase");
        }
