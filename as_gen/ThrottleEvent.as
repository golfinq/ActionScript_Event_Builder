package flash.events
{
    ...
    public class ThrottleEvent extends Event
    {
        ...
        public var _state: String; // [read-only] Describes the state that the player is entering: ThrottleType.THROTTLE, ThrottleType.PAUSE, or ThrottleType.RESUME.
        public var _targetFrameRate: Number; // [read-only] The frame rate that Flash Player or AIR targets after the ThrottleEvent is dispatched.
