package flash.events
{
    ...
    public class StageOrientationEvent extends Event
    {
        ...
        public var _beforeOrientation: String; // [read-only] The orientation of the stage before the change.
        public var _afterOrientation: String; // [read-only] The orientation of the stage after the change.
