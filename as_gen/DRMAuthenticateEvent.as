package flash.events
{
    ...
    public class DRMAuthenticateEvent extends Event
    {
        ...
        public var _header: String; // [read-only] The encrypted content file header provided by the server.
        public var _urlPrompt: String; // [read-only] A prompt for a URL string, provided by the server.
        public var _authenticationType: String; // [read-only] Indicates whether the supplied credentials are for authenticating against Flash Media Rights Management Server (FMRMS) or a proxy server.
        public var _netstream: NetStream; // [read-only] The NetStream object that initiated this event.
        public var _passwordPrompt: String; // [read-only] A prompt for a password credential, provided by the server.
        public var _usernamePrompt: String; // [read-only] A prompt for a user name credential, provided by the server.
