package flash.events
{
    ...
    public class SQLUpdateEvent extends Event
    {
        ...
        public var _table: String; // [read-only] The name of the table whose data change caused the event to be dispatched.
        public var _rowID: Number; // [read-only] The unique row identifier of the row that was inserted, deleted, or updated.
