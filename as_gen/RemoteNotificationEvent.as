package flash.events
{
    ...
    public final class RemoteNotificationEvent extends Event
    {
        ...
        public var _data: Object; // [read-only] Contains a JSON-format notification payload.
        public var _tokenId: String; // [read-only] Cotains the tokenId received from APNs, used to identify the application.
